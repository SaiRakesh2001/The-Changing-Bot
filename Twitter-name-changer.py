...
while True:
    user = api.get_user('Rakesh33005029')
    api.update_profile(name=f'Rakesh|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Rakesh|{follower_count(user)} Followers')
